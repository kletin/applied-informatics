...
//	Airport a = airport;  // Αρχικό αεροδρόμιο
//	Airport b = airport;  // Διαφορετικό αεροδρόμιο από το αεροδρόμιο a
//	String objectString = CentralRegistry.getDirectFlightsDetails(a, b);
//	String objectString1 = 	CentralRegistry.getInDirectFlightsDetails(a, b);
//	
